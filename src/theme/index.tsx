...
.defimist-pagination ul {
  display: inline-flex;
}

.defimist-pagination li {
...
.defimist-pagination li.rc-pagination-item-active {
  border: solid 1px ${props => props.theme.bg4};
}

.defimist-pagination li.rc-pagination-prev,
.defimist-pagination li.rc-pagination-next {
  color: ${props => props.theme.white};
  padding-top: 2px;
}

.defimist-pagination li.rc-pagination-options {
  display: none;
}

.defimist-pagination li.rc-pagination-disabled {
  border: solid 1px ${props => props.theme.bg3};
