import { ChainId, Currency, Token, DMC } from 'defimist-sdk'
...
import DMCLogo from '../../assets/images/dmc.png'
...
export default function CurrencyLogo({
  ...
  const srcs: string[] = useMemo(() => {
    ...
    if (currency instanceof Token) {
      ...
      if (chainId && DMC[chainId] && DMC[chainId].address === currency.address) return [DMCLogo]
