...
import { ChainId, JSBI, Percent, RoutablePlatform, Router, SwapParameters, Trade, TradeType } from 'defimist-sdk'
                ...
                return contract.callStatic[methodName](...args, options)
                  ...
                  .catch(callError => {
                    ...
                    switch (callError.reason) {
                      case 'DefimistRouter: INSUFFICIENT_OUTPUT_AMOUNT':
                      case 'DefimistRouter: EXCESSIVE_INPUT_AMOUNT':
                        errorMessage =
        ...
        return contract[methodName](...args, {
          ...
          .then((response: any) => {
            ...
            const base = `Swap ${inputAmount} ${inputSymbol} for ${outputAmount} ${outputSymbol} ${
              platformName !== RoutablePlatform.DEFIMIST.name ? `on ${platformName}` : ''
            }`
            const withRecipient =
              recipient === account
                ? base
