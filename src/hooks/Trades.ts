import { Currency, CurrencyAmount, Pair, RoutablePlatform, Token, Trade } from 'defimist-sdk'
...
export function useTradeExactInAllPlatforms(
  ...
  const bestTrades = [
    useTradeExactIn(currencyAmountIn, currencyOut, RoutablePlatform.DEFIMIST),
...
export function useTradeExactOutAllPlatforms(
  ...
  const bestTrades = [
    useTradeExactOut(currencyIn, currencyAmountOut, RoutablePlatform.DEFIMIST),
