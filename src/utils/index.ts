...
import { abi as IDefimistRouterABI } from 'defimist-periphery/build/IDefimistRouter.json'
import { ChainId, JSBI, Percent, Token, CurrencyAmount, Currency, Pair, RoutablePlatform } from 'defimist-sdk'
...
const getExplorerPrefix = (chainId: ChainId) => {
  switch (chainId) {
    ...
    case ChainId.DM:
      return 'https://blockscout.com/dm/mainnet'
    default:
...
export function getExplorerLink(
  ...
  if (chainId === ChainId.DM && type === 'token') {
