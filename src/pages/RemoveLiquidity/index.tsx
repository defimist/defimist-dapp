...
import { Currency, currencyEquals, Percent, CurrencyAmount, JSBI, ChainId, RoutablePlatform } from 'defimist-sdk'
...
export default function RemoveLiquidity({
  ...
  const routerAddress = RoutablePlatform.DEFIMIST.routerAddress[chainId ? chainId : ChainId.MAINNET]
  ...
  async function onRemove() {
    ...
    const router = getRouterContract(chainId, library, RoutablePlatform.DEFIMIST, account)
      ...
      <>
        <RowBetween>
          <Text color={theme.text2} fontWeight={500} fontSize={16}>
            {'DMF ' + currencyA?.symbol + '/' + currencyB?.symbol} Burned
          </Text>
          <RowFixed>
