import { CurrencyAmount, JSBI, Trade, Token, RoutablePlatform } from 'defimist-sdk'
                ...
                <PaddedCard py="0px" px="8px">
                  <RowBetween alignItems="center">
                    <TYPE.body fontSize="11px" lineHeight="15px" fontWeight="500">
                      ...
                      {trade.platform.name !== RoutablePlatform.DEFIMIST.name ? (
                        <>
                          {' '}
                    ...
                    <QuestionHelper text="The trade is routed directly to the selected platform, so no swap or network fees are ever added by Defimist." />
                  </RowBetween>
                </PaddedCard>
